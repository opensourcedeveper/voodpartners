		...
		<div class="card">
			<div class="card-header with-border">
				...
				<div class="pull-right">
					<a class="btn btn-primary" href="<?php echo base_url().'admin/client/add' ?>"> <i class="fa fa-plus"></i> Add</a>
				</div>
			</div>
			<div class="card-body">
							...
							<?php foreach ($Records as $Record): ?>
								<tr>
									...
									<td class="text-center">
										<a href="<?php echo base_url()."admin/client/edit/".$Record['id'] ?>" data-toggle="tooltip" data-placement="top" title="Edit">
			...
			$(document).ready(function()
			{
				...
				$('.delete').click(function()
				{
					...
					if (confirm("Do you want to delete this Record?")==true)
						window.location = url+"admin/client/delete/"+id;
					else
						return false;
				})
				...
				if (confirm("Do you want to enable this Record?")==true)
					window.location = url+"admin/client/enable/"+id;
				else
					return false;
			})
				...
				if (confirm("Do you want to disable this Record?")==true)
					window.location = url+"admin/client/disable/"+id;
				else
					return false;
			})
			});
