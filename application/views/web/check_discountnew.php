...
<script type="application/ld+json">
    {
        ...
        },
        {
            ...
            {
                "type":"WebPage",
                "@id": "/check-discount/<?= strtolower($Record['slug']) ?>",
                "name": "<?= $Record['title'] ?>"
            }
        }]
    }
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="" style="font-size: 16px; color: #246A9F;line-height: 1.2;">
                    <strong><a href="<?= base_url() ?>report/<?= strtolower($Record['slug']) ?>"><?= $Record['title'] ?></a></strong>
                </h1>

                <h4 class="mt-3 text-center"><b>Check discount for this report, please complete the form below.</b></h4>
            </div>
            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12 bg-grey form-area mt-4">
                        <div class="col-md-12 col-sm-12 col-xs-12 px-4 bg-grey">
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 mt-4">
                <div class="col-sm-12 head-area mb-20 position-rerative">
                    ...
                    <div class="head-bgareas">
                        <form action="<?= base_url() . 'buyNow/' . $Record['slug'] ?>" method="get">
                            ...
                            <div class="text-center" style="margin: 0px; padding: 0px;">
                                ...
                                <a href="<?= base_url() ?>request-sample/<?= $Record['slug'] ?>" class="btn btn-before-buy">
                                    REQUEST SAMPLE 
